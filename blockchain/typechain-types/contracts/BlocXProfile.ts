...
export interface BlocXProfileInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addressToProfileId"
      | "approve"
...
export interface BlocXProfile extends BaseContract {
  connect(runner?: ContractRunner | null): BlocXProfile;
  waitForDeployment(): Promise<this>;

  interface: BlocXProfileInterface;
  ...
  addressToProfileId: TypedContractMethod<
    [arg0: AddressLike],
    [bigint],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "addressToProfileId"
  ...
  ): TypedContractMethod<[profileURI: string], [bigint], "nonpayable">;
  getFunction(
